...
$$
Once the short-term rate function $i_{t}(\underline{w_t})$ is specified, we have to specify $\psi_t$, $\alpha_t$, and $\psi^{\mathbb{Q}}_t$, that are linked by Eq. \@ref(eq:transfoPQ).
