...
The approximation approach proposed by @Wu_Xia_2016 is based on an approximation to the conditional expectations of forward rates. Consider the forward rate 
$$
f_{n,n+1,t} = (n+1)R_{t,n+1} - n R_{t,n}
$$
It is such that:
$$
B(t,h) = \exp(-f_{t,0,1}-f_{t,1,2}-\dots-f_{t,h-1,h}).
$$
