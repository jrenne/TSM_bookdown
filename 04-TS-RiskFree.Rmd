...
Again, knowing the $\mathbb{Q}$ dynamics allows to compute bond prices in a fast manner, by using Proposition \@ref(prp:reverseMLT) to compute the conditional expectation appearing in \@ref(eq:bondpricesCondExp) (see Example \@ref(exm:nominalBth)).
