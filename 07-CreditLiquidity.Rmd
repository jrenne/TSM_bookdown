...
> Eq. \@ref(eq:standardPriceCredit3) is reminiscent of Eq. \@ref(eq:stdbond), where the risk-free short-term rate $i_t$ is replaced by the *credit-adjusted short-term rate* $\tilde{i}_t$.
