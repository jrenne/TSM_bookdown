...
$$
The binary variable $\ell_t$ is assumed not to Granger-cause $y_t$ (as in Hypothesis \@ref(hyp:A1)) and not to be priced (as in Hypothesis \@ref(hyp:A3)). As in Proposition \@ref(prp:defaultBondclassical)---and more precisely \@ref(eq:lambdaPQ)---this implies that
$$
